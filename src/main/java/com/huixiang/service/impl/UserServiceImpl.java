...
import static com.huixiang.utils.RedisConstants.*;
import static com.huixiang.utils.SystemConstants.USER_NICK_NAME_PREFIX;
    ...
    private void loadMemberLevel(UserDTO userDTO) {
        try {
            ...
            if (userInfo != null && userInfo.getLevel() != null) {
                int level = userInfo.getLevel() ? 1 : 0;
                userDTO.setMemberLevel(level);
                stringRedisTemplate.opsForValue().set(
                        USER_INFO_KEY + userDTO.getId() + ":level",
